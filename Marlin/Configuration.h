...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 106.00
  #define DEFAULT_bedKi 11.25
  #define DEFAULT_bedKd 665.73
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 900, 900, 500, 500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, 14, -2.3 }
...
#define XY_PROBE_SPEED (XY_MAX_FEEDRATE * 60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST HOMING_FEEDRATE_Z

// Feedrate (mm/m) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW (Z_LOW_FEEDRATE * 60)
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (XY_MAX_FEEDRATE * 60)
#define HOMING_FEEDRATE_Z  (Z_MAX_FEEDRATE * 60)
